...
export const MODULE_REGISTRY: Record<string, ModuleDefinition> = {
  ...
  'scheduling.core': {
    ...
    description: 'Core scheduling features.',
  ...
  'scheduling.online': {
    key: 'scheduling.online',
    name: 'Online Booking',
    shortName: 'Online Booking',
    ...
    entitlementFeatureKey: null,
    defaultEnabled: true,
    dependencies: ['scheduling.core'],
    parentModuleKeys: ['scheduling.core'],
  },
  'scheduling.resources': {
    key: 'scheduling.resources',
    name: 'Resource Management',
    shortName: 'Resources',
    description: 'Manage fitting rooms and shared resources.',
    category: ModuleCategory.APPOINTMENTS,
    releaseState: ModuleReleaseState.PRODUCTION,
    core: false,
    entitlementFeatureKey: null,
  ...
  'sales.contracts': {
    ...
    name: 'Contracts',
    shortName: 'Contracts',
    description: 'Digital agreements and contract signing.',
  ...
  'sales.layaway': {
    ...
    name: 'Layaway',
    shortName: 'Layaway',
    description: 'Manage layaway plans.',
    category: ModuleCategory.SALES,
    releaseState: ModuleReleaseState.PRODUCTION,
    core: false,
    entitlementFeatureKey: null,
  ...
  'sales.payment_plans': {
    key: 'sales.payment_plans',
    name: 'Payment Plans',
    shortName: 'Payment Plans',
    description: 'Split payments and financing.',
    category: ModuleCategory.SALES,
    releaseState: ModuleReleaseState.PRODUCTION,
    core: false,
    entitlementFeatureKey: null,
  ...
  'alterations.core': {
    key: 'alterations.core',
    name: 'Alterations Core',
    shortName: 'Alterations',
    description: 'Manage fitting and alteration tasks.',
    category: ModuleCategory.SALES,
    releaseState: ModuleReleaseState.PRODUCTION,
    core: false,
    entitlementFeatureKey: null,
  ...
  'inventory.special_orders': {
    key: 'inventory.special_orders',
    name: 'Special Orders',
    shortName: 'Special Orders',
  ...
  'reports.core': {
    ...
    shortName: 'Reports',
    description: 'Basic business analytics and operational reports.',
  ...
  'reports.accounting': {
    ...
    description: 'General ledgers, reconciliation, and financial exports.',
    category: ModuleCategory.REPORTS,
    releaseState: ModuleReleaseState.PRODUCTION,
    core: false,
  ...
  'reports.analytics': {
    ...
    shortName: 'Analytics',
    description: 'Owner/executive dashboard and KPI tracking.',
    category: ModuleCategory.REPORTS,
    releaseState: ModuleReleaseState.PRODUCTION,
    core: false,
    entitlementFeatureKey: null,
  ...
  'reports.marketing': {
    ...
    name: 'Marketing Attribution',
    shortName: 'Marketing',
    description: 'Lead attribution and marketing ROI tracking.',
    category: ModuleCategory.REPORTS,
    releaseState: ModuleReleaseState.PRODUCTION,
    core: false,
    entitlementFeatureKey: null,
  ...
  'reports.staff': {
    ...
    name: 'Staff Reports',
    shortName: 'Staff',
    description: 'Employee performance and hours reporting.',
    category: ModuleCategory.REPORTS,
    releaseState: ModuleReleaseState.PRODUCTION,
    core: false,
    entitlementFeatureKey: null,
