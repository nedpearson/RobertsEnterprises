...
export const CANONICAL_STATUS_LABELS: Record<CanonicalConnectionStatus, { label: string; bg: string; text: string; border: string }> = {
  ...
  ACCOUNT_SELECTION_REQUIRED: { label: 'Connected — Account Selection Required', bg: 'bg-amber-100', text: 'text-amber-800', border: 'border-status-warning/20' },
  LOCATION_MAPPING_REQUIRED: { label: 'Connected — Location Mapping Required', bg: 'bg-amber-100', text: 'text-amber-800', border: 'border-status-warning/20' },
  PERMISSION_REQUIRED: { label: 'Permission Required', bg: 'bg-orange-100', text: 'text-orange-800', border: 'border-orange-200' },
  REAUTHORIZATION_REQUIRED: { label: 'Reauthorization Required', bg: 'bg-brand-soft', text: 'text-brand-secondary', border: 'border-border-subtle' },
  DEGRADED: { label: 'Degraded', bg: 'bg-amber-100', text: 'text-amber-800', border: 'border-status-warning/20' },
  ...
  CONNECTED_UNVERIFIED: { label: 'Connected — Verification Failed', bg: 'bg-brand-soft', text: 'text-brand-secondary', border: 'border-border-subtle' },
  EXTERNAL_APPROVAL_REQUIRED: { label: 'Provider Approval Required', bg: 'bg-amber-100', text: 'text-amber-800', border: 'border-status-warning/20' },
