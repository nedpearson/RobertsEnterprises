    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="border-stone-200 shadow-xs hover:border-stone-300 transition-all">
          <CardContent className="p-5">
            ...
            <p className="text-xs text-status-success font-semibold mt-1 flex items-center gap-1">
        ...
        <Card className="border-stone-200 shadow-xs hover:border-stone-300 transition-all">
          <CardContent className="p-5">
            ...
            <p className="text-xs text-status-success font-semibold mt-1">Healthy (Target &lt; 18%)</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="border-stone-200 shadow-xs">
        <CardHeader className="p-5 border-b border-stone-100 flex flex-row items-center justify-between">
          ...
          <Button onClick={() => onNavigate('sales')} variant="ghost" size="sm" className="text-xs font-semibold text-brand-primary">
            ...
            <tbody className="divide-y divide-stone-100">
                ...
                <td className="p-4">
                  <div className="flex items-center gap-2">
                    <div className="w-24 bg-stone-100 rounded-full h-2 overflow-hidden">
                      <div className="bg-status-success h-full rounded-full" style={{ width: '88%' }} />
                    </div>
              ...
              <tr className="hover:bg-stone-50/50 transition-colors">
                ...
                <td className="p-4">
                  <div className="flex items-center gap-2">
                    <div className="w-24 bg-stone-100 rounded-full h-2 overflow-hidden">
                      <div className="bg-status-warning h-full rounded-full" style={{ width: '65%' }} />
                    </div>
                ...
                <td className="p-4">
                  <Badge className="bg-amber-100 text-amber-800 border-status-warning/20">Needs Attention</Badge>
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {[
              ...
              <div key={stylist.name} className="flex items-center justify-between p-3 rounded-xl bg-stone-50 border border-stone-100">
                ...
                <div className="text-right">
                  ...
                  <p className="text-[10px] text-status-success font-semibold">{stylist.conversion} conversion</p>
                </div>
              </div>
            ))}
          </CardContent>
        ...
        <Card className="border-stone-200 shadow-xs">
          ...
          <CardContent className="p-4 space-y-3 text-xs">
            <div className="p-3 rounded-xl bg-brand-soft border border-border-subtle text-brand-secondary flex items-start justify-between gap-3">
              <div>
