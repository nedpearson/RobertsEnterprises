                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input value={ownerData.firstName} onChange={e => setOwnerData({...ownerData, firstName: e.target.value})} />
                    </div>
                    <div className="space-y-2">
                      <Label>Last Name</Label>
                      <Input value={ownerData.lastName} onChange={e => setOwnerData({...ownerData, lastName: e.target.value})} />
                    </div>
                  </div>
...
content = re.sub(
    r"\{currentStep > 2 && currentStep < 12 && \(.*?</p>\s*</div>\s*\)\}",
    ui_components.strip(),
    content,
    flags=re.DOTALL
)
